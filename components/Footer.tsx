      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-12 mb-16">
          {footerLinks.map((column, idx) => (
            <div key={idx}>
              <h4 className="text-sm font-bold text-[#0f172a] uppercase tracking-widest mb-6">
                {column.title}
              </h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center group cursor-pointer" onClick={() => onNavigate('resume')}>
            ...
            <span className="ml-2 text-xl font-bold lowercase tracking-tighter text-[#0f172a]">zysculpt</span>
          </div>

          <p className="text-[#94a3b8] text-sm tracking-tight">
